    ...
    <div class="modal-content">
      ...
      <div class="modal-body ativa-scroll">
        ...
        <div id="fa-top" class="tab-content">
            ...
            <div id="icons" class="icon-lists">
                <div class="form-group">
                <div class="input-group input-group-lg">
                    <span class="input-group-addon" id="sizing-addon1"><i class="fa fa-search"></i></span>
                    <input class="search form-control input-lg" placeholder="Search Icons" />
                </div>
                </div>

                  <div class="row fontawesome-icon-list list">
                ...
                <div class="fa-hover col-xs-6 col-sm-4"><a class="icon" href="#"><i class="fa fa-<?php echo $icon; ?>"></i> <?php echo $icon; ?></a></div>
                    <?php
                    }
                ?>
                    </div>
